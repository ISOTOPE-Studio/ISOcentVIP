                ...
                if (args.length > 1 && args[1].equals("month")) {
                    ...
                    if (plugin.playerPoints.getAPI().take(player.getName(), Settings.mVIPPrice)) {
                        if (PlayerData.addDays(player.getName(), 30 * month)) {
                            ...
                            if (!PlayerData.ifChecked(player.getName())) {
                                PlayerData.addPoints(player.getName(), Settings.yVIPPoints);
                                PlayerData.setChecked(player.getName(), true);
                            }
                        } else {
                            if (!PlayerData.ifChecked(player.getName())) {
                                PlayerData.addPoints(player.getName(), Settings.mVIPPoints);
                                PlayerData.setChecked(player.getName(), true);
                            }
                        }
